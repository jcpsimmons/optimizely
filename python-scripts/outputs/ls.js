...
}}]}], "name": "Original (Click Tracking on \"More Like This\")"}, {"id": "16852372764", "actions": [{"viewId": "16848343179", "changes": [{"dependencies": [], "type": "custom_code", "id": "75D184E3-8419-4089-BDF6-BC20D43AF24D", "value": function($){$(document).ready(function() {
  function titleCase(str) {
    str = str.toLowerCase().split(" ");
    var final = [];
    for (i = 0; i < str.length; i++) {
...
}}]}], "name": "Original (Click Tracking on \"More Like This\")"}, {"id": "16836905762", "actions": [{"viewId": "16848343179", "changes": [{"dependencies": [], "type": "custom_code", "id": "94971873cccc4102b47c3be25f1a6787", "value": function($){$(document).ready(function() {
  function titleCase(str) {
    str = str.toLowerCase().split(" ");
    var final = [];
    for (i = 0; i < str.length; i++) {
...
function pollingFn() {
  return utag.data.category_id == 'mattresses';
    ...
    return utag_data.page_type == "category" || utag_data.page_type == "search";
  }, "deactivationEnabled": false, "id": "12608370107"}, {"category": "other", "staticConditions": ["and", ["or", {"type": "url", "value": "www.livingspaces.com", "match": "simple"}]], "activationType": "polling", "name": "Home - Welcome-overlay", "apiName": "8788531144_global__welcomeoverlay", "tags": [], "undoOnDeactivation": false, "activationCode": function polling () {
