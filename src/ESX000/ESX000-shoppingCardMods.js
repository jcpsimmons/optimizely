const shoppingCartModifications = () => {
  const MOBILE = !!document.querySelectorAll(".ls-t-mobile").length;
  ...
  function waitForjQuery($) {
    ...
    trigger.click(function() {
      var theModal = $(this).data("target"),
        ...
        videoSRCauto =
          videoSRC +
          "?rel=0&vq=1080&controls=1&autoplay=1&modestbranding=1&showinfo=0";
    ...
    // redefine close functionality to only apply to current modal
    $(
      "#shippingVersusFullDelivery > .modal-dialog > .modal-content > button.close"
    ).click(function(e) {
      e.preventDefault();
      e.stopPropagation();
    ...
    // z index fix - dynamic works on desktop, need to hard-code for mobile
    if (MOBILE) {
