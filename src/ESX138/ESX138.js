...
var anotherInterval = setInterval(() => {
  if (typeof window.jQuery !== 'undefined' && $('#omniinventory').length > 0) {
    ...
    packageDimensions = $("th:contains('Package')")
      ...
      .text()
      .trim();
    insertHtml = `<li id='packageModalClick'><span src='Content/images/assets/pickup-20x20.png' role='presentation' alt='' style='max-width: 1.8rem;' class='fa fa-cube'></span><img src='Content/images/assets/pickup-138.png' class='hidden in-store' role='presentation' alt=''>Package Dimensions: ${
      packageDimensions
