...
var message = [
  "FREE shipping nationwide ALL accessories",
  '<span >No minimum purchase needed. <a href="/company/shipping-faqs#parcel">Learn more &rsaquo;</a></span >',
];
...
if (utag_data.site_type == "mobile") {
  message = [
    "FREE Shipping",
    '<span ><a href="/delivery">on all accessories, nationwide &rsaquo;</a></span >',
  ];
  padding = ".7rem 0";
}
document
