  ...
  var generateHtml = function generateHtml() {
    var formatHtml = function formatHtml(
      ...
      return '<div id="BVQAQuestionAndAnswers'
        .concat(
          randomId,
          '" class="BVQAQuestionAndAnswers BVQAQuestionAndAnswersProduct BVQAQuestionAndAnswersNative BVQAQuestionAndAnswersQuestionWithStaffAnswer"> <div id="BVQAQuestionHeader'
        )
        .concat(
          randomId,
          '" class="BVQAQuestionHeader BVQAQuestionHeaderClosed" onclick=" $bv(\'#BVQAQuestionMain'
        )
        .concat(randomId, "').toggle(); $bv('#BVQAQuestionHeader")
        .concat(
          randomId,
          "').toggleClass('BVQAQuestionHeaderClosed').toggleClass('BVQAQuestionHeaderOpen'); if ($bv('#BVQAQuestionMain"
        )
        .concat(
          randomId,
          "').is(':visible')) { BVAnalyticsTracker.fireActionEvent(this, 'BV_TrackingTag_Question_questionExpansion',{'questionIds':['"
        )
        .concat(
          randomId,
        ...
        .concat(
          randomId,
          '\');"> <div class="BVQAQuestionHeaderBadgeIcons"> <div class="BVQAQuestionHeaderBadgeIconContainer"> <div id="BVQAQuestionHeaderBadgeIcon'
        )
        .concat(
          randomId,
          'QuestionWithStaffAnswerID" class="BVQAQuestionHeaderBadgeIcon BVQAQuestionHeaderBadgeIconQuestionWithStaffAnswer" onmouseover="$bv(\'#BVQAQuestionHeaderBadgeIconHint'
        )
        .concat(
          randomId,
          "QuestionWithStaffAnswerID').removeClass('BVQAHidden'); BVAnalyticsTracker.fireActionEvent(this);\" onmouseout=\"$bv('#BVQAQuestionHeaderBadgeIconHint"
        )
        .concat(
          randomId,
          "QuestionWithStaffAnswerID').addClass('BVQAHidden');\"> </div> <div id=\"BVQAQuestionHeaderBadgeIconHint"
        )
        .concat(
          randomId,
          'QuestionWithStaffAnswerID" class="BVQAHidden BVQAQuestionHeaderBadgeIconHint">Has staff answer</div> </div> </div> <div class="BVQAQuestionHeaderBullet">&nbsp;</div> <div class="BVQAQuestionAnswersCount"><span class="BVQACount BVQANonZeroCount"><span class="BVQANumber">1</span> answer</span></div> <div class="BVQAQuestionSummary" role="heading" aria-level="3"> <a href="javascript:void(0);" role="button" aria-expanded="false">'
        )
        .concat(questionTitle, '</a> </div> </div> <div id="BVQAQuestionMain')
        .concat(
          randomId,
          '" class="BVQAQuestionMain" style="display: none;"> <div id="BVQAQuestion'
        )
        .concat(
          randomId,
          '" class="BVQAContent BVQAQuestion"> <div class="BVQAContentText BVQAQuestionDetails"> <div class="BVQAContentLabel BVQAQuestionLabel"></div>'
        )
        .concat(
          question,
          ' </div> <div class="BVQAQuestionTagsSection"> <div class="BVQATagsContainer"></div> </div> <div class="BVQAContextDataContainer BVQAQuestionContextDataContainer"> <div class="BVQAContextDataValueContainer BVQAContextDataValueContainerAge BVContextDataAge25to34"><span class="BVQALabel BVQAContextDataValuePrefix BVQAContextDataValueAgePrefix">Age:&nbsp;</span><span class="BVQAValue BVQAContextDataValue BVQAContextDataValueAge">25-34</span><span class="BVQALabel BVQAContextDataValueSuffix BVQAContextDataValueAgeSuffix"></span></div> <div class="BVQAContextDataValueContainer BVQAContextDataValueContainerGender BVContextDataGender'
        )
        .concat(
          gender,
          '"> <span class="BVQALabel BVQAContextDataValuePrefix BVQAContextDataValueGenderPrefix">Gender:&nbsp;</span><span class="BVQAValue BVQAContextDataValue BVQAContextDataValueGender">'
        )
        .concat(
          gender,
          '</span><span class="BVQALabel BVQAContextDataValueSuffix BVQAContextDataValueGenderSuffix"></span></div> <div class="BVQAContextDataValueContainer BVQAContextDataValueContainerHomeStyle BVContextDataHomeStyleLoftUrban"> <span class="BVQALabel BVQAContextDataValuePrefix BVQAContextDataValueHomeStylePrefix">Home Style:&nbsp;</span><span class="BVQAValue BVQAContextDataValue BVQAContextDataValueHomeStyle">Loft/Urban</span><span class="BVQALabel BVQAContextDataValueSuffix BVQAContextDataValueHomeStyleSuffix"></span></div> </div> <div class="BVQAContentData BVQAQuestionData"> <div class="BVQAElapsedTime">1 day ago</div> <div class="BVQASignature"><span class="BVQAAvatar"><a onmouseover=" bvProfileSnapshot.showHiddenPopinAfterDelay(\'BVDI_PSPopin_oql5w0wxkjghi8f0zxgakhz4l_ID\', \'https://livingspaces.ugc.bazaarvoice.com/answers/3534-en_us/3jeu5webls5hyi33j188ucoot/profilesnapshot.djs?format=embeddedhtml\', \'ProfileSnapshotFrame\' ,500, 500 ) &amp;&amp; BVAnalyticsTracker.fireActionEvent(this); " onmouseout=" bvProfileSnapshot.hideOpenPopinAfterDelay(1000 ,250 ); " onclick="var popupWin = window.open(this.href, null, \'resizable=1,status=1,scrollbars=1,width=800,height=600,top=0\'); popupWin.focus(); event.preventDefault?event.preventDefault():event.returnValue = false;" data-bvtrack="eName:ProfileLink" href="https://livingspaces.ugc.bazaarvoice.com/profiles/3534-en_us/3jeu5webls5hyi33j188ucoot/profile.htm" class="BVQALink" name="BV_TrackingTag_Question_Display_ReadAllQA_'
        )
        .concat(
          randomName,
          '"><span class="BVQALinkSpan"><img src="https://livingspaces.ugc.bazaarvoice.com/answers/3534-en_us/static/noAvatar.gif" alt="Customer Avatar" title="Customer Avatar"></span></a></span> <div class="BVQAWrittenBy">by </div> <div class="BVQANickname"><a onmouseover=" bvProfileSnapshot.showHiddenPopinAfterDelay(\'BVDI_PSPopin_oql5w0wxkjghi8f0zxgakhz4l_ID\', \'https://livingspaces.ugc.bazaarvoice.com/answers/3534-en_us/3jeu5webls5hyi33j188ucoot/profilesnapshot.djs?format=embeddedhtml\', \'ProfileSnapshotFrame\' ,500, 500 ) &amp;&amp; BVAnalyticsTracker.fireActionEvent(this); " onmouseout=" bvProfileSnapshot.hideOpenPopinAfterDelay(1000 ,250 ); " onclick="var popupWin = window.open(this.href, null, \'resizable=1,status=1,scrollbars=1,width=800,height=600,top=0\'); popupWin.focus(); event.preventDefault?event.preventDefault():event.returnValue = false;" data-bvtrack="eName:ProfileLink" href="https://livingspaces.ugc.bazaarvoice.com/profiles/3534-en_us/3jeu5webls5hyi33j188ucoot/profile.htm" title="Read all my Q&amp;A" class="BVQANickname" name="BV_TrackingTag_Question_Display_ReadAllQA_'
        )
        .concat(randomName, '">')
        .concat(
          randomName,
          '</a></div> <div class="BVQALocation">California</div><a onmouseover=" bvProfileSnapshot.showHiddenPopinAfterDelay(\'BVDI_PSPopin_oql5w0wxkjghi8f0zxgakhz4l_ID\', \'https://livingspaces.ugc.bazaarvoice.com/answers/3534-en_us/3jeu5webls5hyi33j188ucoot/profilesnapshot.djs?format=embeddedhtml\', \'ProfileSnapshotFrame\' ,500, 500 ) &amp;&amp; BVAnalyticsTracker.fireActionEvent(this); " onmouseout=" bvProfileSnapshot.hideOpenPopinAfterDelay(1000 ,250 ); " onclick="var popupWin = window.open(this.href, null, \'resizable=1,status=1,scrollbars=1,width=800,height=600,top=0\'); popupWin.focus(); event.preventDefault?event.preventDefault():event.returnValue = false;" data-bvtrack="eName:ProfileLink" href="https://livingspaces.ugc.bazaarvoice.com/profiles/3534-en_us/3jeu5webls5hyi33j188ucoot/profile.htm" title="Read all my Q&amp;A" class="BVQAUserProfile" name="BV_TrackingTag_Question_Display_ReadAllQA_'
        )
        .concat(
          randomName,
          '"> <img src="https://livingspaces.ugc.bazaarvoice.com/answers/3534-en_us/static/moreQuestionsAndAnswers.gif" alt="Read all my Q&amp;A"> </a> <div class="BVDI_PSSpacer">&nbsp;</div> <div class="BVDI_PS BVDI_PSPopin BVDIHidden BVDI_PSNotLoaded BVQA_PSPopin BVBrowserWebkit" id="BVDI_PSMetaData_oql5w0wxkjghi8f0zxgakhz4l_ID" onmouseover=" bvProfileSnapshot.showHiddenPopinAfterDelay(\'BVDI_PSPopin_oql5w0wxkjghi8f0zxgakhz4l_ID\', \'https://livingspaces.ugc.bazaarvoice.com/answers/3534-en_us/3jeu5webls5hyi33j188ucoot/profilesnapshot.djs?format=embeddedhtml\', \'ProfileSnapshotFrame\' ,500, 500 ) &amp;&amp; BVAnalyticsTracker.fireActionEvent(this); " onmouseout=" bvProfileSnapshot.hideOpenPopinAfterDelay(1000 ,250 ); "> <div class="BVDI_PSInside"> <div class="BVDI_PSSnapshotContainer BVQA_PS_3jeu5webls5hyi33j188ucoot_Container"> <div class="BVDI_PSSnapshotNotLoaded" style="display: none">&nbsp;</div> <div class="BVDI_PSSnapshotLoading"><img src="https://livingspaces.ugc.bazaarvoice.com/answers/3534-en_us/static/profileSnapshotLoading.gif" alt="Please wait while more information about '
        )
        .concat(
          randomName,
          ' is loaded." title="Please wait while more information about '
        )
        .concat(
          randomName,
          ' is loaded."></div> <div class="BVDI_PSSnapshotTimeoutError BVDIHidden">Additional information about '
        )
        .concat(
          randomName,
          ' could not be loaded. </div> </div> </div> </div> </div><div class="BVDI_FV"> <div class="BVDI_FVVoting BVDI_FVVotingHelpfulness"> <div class="BVDI_FVSum BVDI_FVSumHelpfulness"><span class="BVDI_FVZero BVDI_FVLevel1"><span class="BVDIValue BVDINumber">0</span><span class="BVDISuffix">points</span></span> </div> <div class="BVDI_FVCounts BVDI_FVCountsHelpfulness"><span class="BVDI_FVPositive BVDI_FVLevel1"><span class="BVDIValue BVDINumber">0</span><span class="BVDISuffix">out of</span></span> <span class="BVDI_FVTotal BVDI_FVLevel1"><span class="BVDIValue BVDINumber">0</span><span class="BVDISuffix">found this question helpful.</span></span></div> <div class="BVDI_FVVotes BVDI_FVVotesHelpfulness"><span class="BVDIPrefix">Was this helpful?</span><span class="BVDI_FVVote BVDI_FVPositive BVDI_FVLevel1"><a data-bvjsref="https://livingspaces.ugc.bazaarvoice.com/answers/submit/3534-en_us/product/223508/question/'
        )
        .concat(
          randomId,
          "/positive.djs?authsourcetype=__AUTHTYPE__&amp;format=embeddedhtml&amp;innerreturn=https%3A%2F%2Flivingspaces.ugc.bazaarvoice.com%2Fanswers%2F3534-en_us%2Fproduct%2F223508%2Fquestions.djs%3Fexpandquestion%3D"
        )
        .concat(
          randomId,
          '%26format%3Dembeddedhtml%26scrolltotop%3Dtrue&amp;return=https%3A%2F%2Fwww.livingspaces.com%2Fpdp-turdur-sofa-223508&amp;sessionparams=__BVSESSIONPARAMS__&amp;submissionparams=__BVSUBMISSIONPARAMETERS__&amp;submissionurl=&amp;user=__USERID__" data-bvcfg="755200077" href="javascript://" title="" class="BVDILink BVDIValue" name="BV_TrackingTag_Question_Display_AddPositiveFeedback_'
        )
        .concat(
          randomId,
          '" role="button" tabindex="0" aria-pressed="false"><span class="BVDILinkSpan"><span class="screen-reader">Was this helpful?</span><span class="BVDILabel">Yes</span><span class="BVDINumber">0</span></span></a></span><span class="BVDI_FVVote BVDI_FVNegative BVDI_FVLevel1"><a data-bvjsref="https://livingspaces.ugc.bazaarvoice.com/answers/submit/3534-en_us/product/223508/question/'
        )
        .concat(
          randomId,
          "/negative.djs?authsourcetype=__AUTHTYPE__&amp;format=embeddedhtml&amp;innerreturn=https%3A%2F%2Flivingspaces.ugc.bazaarvoice.com%2Fanswers%2F3534-en_us%2Fproduct%2F223508%2Fquestions.djs%3Fexpandquestion%3D"
        )
        .concat(
          randomId,
        ...
        .concat(
          randomId,
          "/undohelpfulness.djs?authsourcetype=__AUTHTYPE__&amp;format=embeddedhtml&amp;innerreturn=https%3A%2F%2Flivingspaces.ugc.bazaarvoice.com%2Fanswers%2F3534-en_us%2Fproduct%2F223508%2Fquestions.djs%3Fexpandquestion%3D"
        )
        .concat(
          randomId,
