$(document).ready(function () {
  ...
  var secondLink = "<a id='animation2' class='banner-text white-link' href='https://www.livingspaces.com/company/financing'><i class='fa fa-credit-card' aria-hidden='true'></i> Special Financing Available Today &rsaquo;</a>";
  $('.promo').html(firstLink);

  function addRemAnimation() {
    $('.promo').removeClass('in-n-out').addClass('in-n-out');
  }
