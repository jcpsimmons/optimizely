...
var message = ["New! FREE 2-Day Shipping", '<span >Eligible on all orders over $500. <a href="/delivery">Check availability in your area &rsaquo;</a></span >'];
var padding = "1.2rem 0";

if (utag_data.site_type == "mobile") {
  message = ["FREE 2-Day Shipping", '<span ><a href="/delivery">Check your availability &rsaquo;</a></span >'];
  padding = ".7rem 0";
}
