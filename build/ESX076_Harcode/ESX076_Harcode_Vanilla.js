...
var busInterval = setInterval(function () {
  if (typeof window.EventBus !== "undefined" && typeof window.jQuery !== "undefined" && typeof utag_data !== "undefined") {
...
function success(pos) {
  ...
  document.getElementById("geo_location").insertAdjacentHTML("beforeend", '<p><i class="fa fa-map-marker" aria-hidden="true"></i> Your Nearest Store:</p> <p id="geo_str_name"><strong>' + strObj[selectedStore].name + "</strong> " + storeMiles + '</p> <p id="geo_str_address">' + strObj[selectedStore].address + '</p> <a id="geo_direction_link" target="_blank" href="' + strObj[selectedStore].link + '">Directions &rsaquo;</a>');
