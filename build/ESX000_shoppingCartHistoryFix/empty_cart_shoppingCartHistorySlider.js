function cartHistorySliderMobile() {
  ...
  function constructSlider(productList, viewAllHref) {
    ...
    if (isShoppingCart) {
      ...
      document.querySelector("body").insertAdjacentHTML("afterbegin", "<style> #shoppingCartHistory_box > .container {padding: 0;} #shoppingCartHistory_box .slick-slide img {padding-left: 1.5rem;}</style>");
