function nested() {
  ...
  style.type = "text/css";
  style.innerHTML =
    "body {overflow-x:hidden} .stickyStyle { position:sticky;top:0;width:100%; padding-top:2rem;z-index:1041} .dropdownMenus { padding-top: 0; } #floating-banner-bg { background-color:rgba(255,255,255,.9); border-bottom: 1px solid grey; position: absolute; top: 0; width: 300%; height: 11rem; transform: translateX(-50%); box-shadow: 0 5.3px 3px -4px grey; } @media screen and (max-width: 990px) { #floating-banner-bg { height: 13rem; } }";
