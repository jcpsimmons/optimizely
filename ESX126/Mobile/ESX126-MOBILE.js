var anotherInterval = setInterval(() => {
  if (typeof window.jQuery !== 'undefined') {
    ...
    window.$.get(queryUrl, (data) => {
      ...
      let slickSliderInjection = "<div id='moreInThisSizeContainer' class='collapse in' aria-expanded='true' style><div id='moreInThisSize' class='slick-matching-colors mobile-carousel-component'>";
    ...
    $('body').on('click', '#moreInThisSizeContainer', () => {
